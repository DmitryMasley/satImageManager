...
double calcSSIM(cv::Mat& src1, cv::Mat& src2, int channel, int method, const double K1, const double K2,	const int L, const int downsamplewidth, const int gaussian_window, const double gaussian_sigma)
{
    Mat mask; Mat map;
    return calcSSIM(src1, src2, mask, map, channel,  method, K1, K2, L, downsamplewidth, gaussian_window, gaussian_sigma);
}

double calcSSIM(cv::Mat& src1, cv::Mat& src2, cv::Mat& mask, cv::Mat& ssim_map, int channel, int method, const double K1, const double K2,	const int L, const int downsamplewidth, const int gaussian_window, const double gaussian_sigma)
{
...
double calcSSIMBB(cv::Mat& src1, cv::Mat& src2, int channel, int method, int boundx, int boundy, const double K1, const double K2, const int L, const int downsamplewidth, const int gaussian_window, const double gaussian_sigma)
{
    Mat ssim_map;
    return calcSSIMBB(src1, src2, ssim_map, channel, method, boundx, boundy, K1, K2, L, downsamplewidth, gaussian_window, gaussian_sigma);
}
double calcSSIMBB(cv::Mat& src1, cv::Mat& src2, cv::Mat& ssim_map, int channel, int method, int boundx, int boundy, const double K1, const double K2, const int L, const int downsamplewidth, const int gaussian_window, const double gaussian_sigma)
{
    IplImage Src1 = IplImage(src1);
    IplImage Src2 = IplImage(src2);
    IplImage Ssim_map = IplImage(ssim_map);
